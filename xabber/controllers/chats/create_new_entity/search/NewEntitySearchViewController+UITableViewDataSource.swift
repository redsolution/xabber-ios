...
extension NewEntitySearchViewController: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        guard let item = contacts?[indexPath.row],
            let cell = tableView.dequeueReusableCell(withIdentifier: NewEntityViewController.ContactCell.cellName, for: indexPath) as? NewEntityViewController.ContactCell else {
                fatalError()
        }
