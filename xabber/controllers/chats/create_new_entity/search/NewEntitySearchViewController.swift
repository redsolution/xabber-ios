...
class NewEntitySearchViewController: BaseViewController {
    
    open var delegate: NewEntityViewControllerDelegate? = nil
    open var callback: ((String, String) -> Void)? = nil
    ...
    internal let tableView: UITableView = {
        ...
        view.register(NewEntityViewController.ContactCell.self,
                      forCellReuseIdentifier: NewEntityViewController.ContactCell.cellName)
