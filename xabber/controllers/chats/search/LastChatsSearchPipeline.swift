...
struct LastChatsSearchLocalPageLoader: @unchecked Sendable {
    ...
    private func directoryPage(
        ...
        if phase == .conversations {
            ...
            let page = LastChatsSearchPageMaterializer.materialize(
                ...
                limit: request.limit,
                transform: Self.conversationProjection
            )
        ...
        let rosterPage = LastChatsSearchPageMaterializer.materialize(
            ...
            limit: remaining,
            transform: Self.rosterProjection
        )
    ...
    private func messagePage(
        ...
        let page = LastChatsSearchPageMaterializer.materialize(
            messages,
            limit: request.limit,
            transform: Self.messageProjection
        )
        let nextCursor: LastChatsSearchCursor?
    ...
    private static func conversationProjection(_ item: LastChatsStorageItem) -> LastChatsSearchItem {
        LastChatsSearchItem(
    ...
    private static func rosterProjection(_ item: RosterStorageItem) -> LastChatsSearchItem {
    ...
    static func messageProjection(_ item: MessageStorageItem) -> LastChatsSearchItem {
