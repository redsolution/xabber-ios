...
open class MessageLabel: UILabel {
    ...
    public static var defaultURLAttributes: [NSAttributedString.Key: Any] = {
        return [
            NSAttributedString.Key.foregroundColor: MDCPalette.blue.tint900,
            NSAttributedString.Key.underlineStyle: NSUnderlineStyle.single.rawValue,
            NSAttributedString.Key.underlineColor: MDCPalette.blue.tint900,
        ]
    }()
    ...
    open internal(set) var urlAttributes: [NSAttributedString.Key: Any] = defaultURLAttributes
