...
//
//class VideoMessageCell: CommonMessageCell {
//    
//    var mediaView: InlineVideosGridView = {
...
//            mediaView.frame = CGRect(x: messageContainerView.bounds.minX + insets.left + 2,
...
//        
//        switch message.kind {
//        case .files(let videos): //Is used for videos
//            mediaView.datasource = datasource
//            mediaView.configure(videos, messageId: nil, indexPath: indexPath)
//        default: break
//        }
