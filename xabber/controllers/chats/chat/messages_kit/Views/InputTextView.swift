...
final class InputTextView: UITextView {
    ...
    final var images: [UIImage] {
        return parseForAttachedImages()
    }
    
    final var components: [Any] {
    ...
    public let placeholderLabel: UILabel = {
        ...
        label.text = "Message".localizeString(id: "message", arguments: [])
    ...
    final var placeholderTextColor: UIColor? = .lightGray {
        didSet {
    ...
    final override var textAlignment: NSTextAlignment {
        didSet {
            placeholderLabel.textAlignment = textAlignment
        }
    }
    
    final override var scrollIndicatorInsets: UIEdgeInsets {
        didSet {
    ...
    final func postTextViewDidChangeNotification() {
    ...
    final override func paste(_ sender: Any?) {
