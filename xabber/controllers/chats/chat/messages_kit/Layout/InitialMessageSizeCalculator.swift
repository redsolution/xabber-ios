...
class InitialMessageSizeCalculator: MessageSizeCalculator {
    
    var messageLabelInsets = UIEdgeInsets(top: 10, left: 24, bottom: 10, right: 24)
    ...
    override func messageContainerMaxWidth(for message: MessageType) -> CGFloat {
        let maxWidth = super.messageContainerMaxWidth(for: message) + 48 + 36
