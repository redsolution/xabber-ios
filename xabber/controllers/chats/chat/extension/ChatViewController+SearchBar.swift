...
extension ChatViewController {
    ...
    internal func cancelSearchModeFromSearchUI() {
        ...
        updateChatInputKeyboardLayoutMode()
        xabberInputView.update(screenHeight: view.bounds.height, keyboardHeight: 0)
        updateChatCollectionInsets(inputHeight: xabberInputView.bounds.height)
