...
extension AccountNewStatusViewController {
    class CustomStatus: UITableViewCell {
        
        static let cellName = "StatusCustomCell"
        ...
        var field: UITextField = {
            ...
            field.restorationIdentifier = "customStatusFieldRID"
        ...
        func configure(for title: String, value: String) {
            addSubview(stack)
            selectionStyle = .none
            stack.fillSuperview()
