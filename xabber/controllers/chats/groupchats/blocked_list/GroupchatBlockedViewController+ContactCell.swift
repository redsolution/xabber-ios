...
extension GroupchatBlockedViewController {
    class ContactCell: UITableViewCell {
        ...
        open func configure(_ jid: String, owner: String, username: String, status: ResourceStatus, avatarKey: String, selected: Bool, failed: Bool) {
            usernameLabel.text = username
            statusLabel.text = jid
            
//            switch status {
//            case .groupchat, .incognitoChat, .bot, .server:
