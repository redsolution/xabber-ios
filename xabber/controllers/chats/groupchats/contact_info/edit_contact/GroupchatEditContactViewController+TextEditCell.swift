...
extension GroupchatEditContactViewController {
    class TextEditCell: UITableViewCell {
        public static let cellName: String = "TextEditCell"
        ...
        var delegate: GroupchatEditContactDelegate? = nil

        @objc
        internal func onValueChanged(_ sender: UITextField) {
           delegate?.onUpdateTextField(itemId, value: sender.text)
        }
        ...
        open func configure(_ itemId: String, placeholder: String, value: String?) {
           self.itemId = itemId
