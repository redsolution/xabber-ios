...
enum ChatAttachmentLocalizationKey: String, CaseIterable {
    ...
    case geolocationSnapshotFailedMessage = "chat_attachment_geolocation_snapshot_failed_message"
    ...
    var defaultValue: String {
        ...
        case .geolocationSnapshotFailedMessage: return "Could not prepare the map preview."
