...
struct DeleteItemPresenter {
    
    func present(in view: UIViewController, title: String?, message: String?, deleteText: String, cancelText: String, animated: Bool, completion: @escaping ((Bool)->Void)) {
