...
//        else if let uploader = AccountManager.shared.find(for: self.owner)?.getDefaultUploader() as? HTTPUploadsManager {
            
//            uploader.upload(stream, message: primary, error: {
//                do {
//                    let realm = try Realm()
//                    if let instance = realm.object(ofType: MessageStorageItem.self, forPrimaryKey: primary) {
//                        try realm.write {
...
//        }
//        XMPPUIActionManager.shared.performRequest(owner: self.owner, action: { (stream, session) in
//            if let uploader = session.getDefaultUploader() as? UploadManagerExtendedProtocol {
//                uploader.getFileData(message: primary, successCallback: {
//                    do {
//                        let realm = try  WRealm.safe()
//                        if let instance = realm.object(ofType: MessageStorageItem.self, forPrimaryKey: primary) {
...
//                    }
//                })
//            } else if let uploader = session.getDefaultUploader() as? HTTPUploadsManager {
//                uploader.upload(stream, message: primary, error: {
//                    do {
//                        let realm = try Realm()
//                        if let instance = realm.object(ofType: MessageStorageItem.self, forPrimaryKey: primary) {
...
//                        }
//                    })
//                } else if let uploader = user.getDefaultUploader() as? HTTPUploadsManager {
//                    uploader.upload(stream, message: primary, error: {
//                        do {
//                            let realm = try Realm()
//                            if let instance = realm.object(ofType: MessageStorageItem.self, forPrimaryKey: primary) {
